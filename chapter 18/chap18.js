...
function buyLunches() {
    ...
    while (money > 0) {
        ...
        if (money >= totalPrice) {
            ...
            document.getElementById("receipt").innerHTML += "<p> Today,sandwiches are:$" + priceToday + ".You don't have enough ,oney.Maybe your sister will give you some of her sandwich.</p>";
